<?php 
	...
	class ControladorDescuentos{
		...
		static public function ctrMostrarDescuento($item, $valor,$var, $order){
			...
			$respuesta=ModeloDescuentos::MdlMostrarDescuento($tabla, $item, $valor,$var,$order);
			return $respuesta;
		}
		...
		/*============================================================
 		...
 		static public function ctrMostrarDescuentoCanal($item, $valor){
			...
			$respuesta=ModeloDescuentos::MdlMostrarDescuentoCanal($tabla1, $tabla2, $item, $valor);
		...
		static public function ctrBorrarDescuento($item, $valor){
				...
				$respuesta = ModeloDescuentos::mdlEliminarDescuento($tabla, $item, $valor);
