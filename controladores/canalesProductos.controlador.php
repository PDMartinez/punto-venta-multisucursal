<?php 
	...
	class ControladorCanalesProductos{
		...
		static public function ctrMostrarCanal($item, $valor,$var, $order){
			...
			$respuesta=ModeloCanalesProductos::MdlMostrarCanal($tabla, $item, $valor, $var, $order);
		...
		static public function ctrCrearCanal($datos){
			...
			if(isset($datos["txtCanal"])){
				   ...
				   preg_match('/^[0-9. ]+$/', $datos["Estado"]))
				{
				    ...
				    $respuesta=ModeloCanalesProductos::mdlIngresarCanal($tabla, $datos);
 		...
 		static public function ctrEditarCanal($datos){
			...
			if(isset($datos["txtCanal"])){
				   ...
				   preg_match('/^[0-9. ]+$/', $datos["Estado"]))
				{
				    ...
				    $respuesta=ModeloCanalesProductos::mdlEditarCanal($tabla, $datos);
		...
		static public function ctrBorrarCanal($item, $valor){
				...
				$respuesta = ModeloCanalesProductos::mdlEliminarCanal($tabla, $item, $valor);
