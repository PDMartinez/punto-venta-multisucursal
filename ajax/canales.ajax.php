...
class AjaxCanales{
	...
	public function ajaxGuardarCanal(){
		...
		if(($this->tokenCanal) != ""){
			...
			$respuesta = ControladorCanales::ctrEditarCanal($datos);
			...
			die();
				...
				$respuesta = ControladorCanales::ctrCrearCanal($datos);
	...
	public function ajaxEditarCanal(){
        ...
        $respuesta = ControladorCanales::ctrMostrarCanal($item, $valor, $var, $order);
	...
	public function ajaxEliminarCanal(){
		...
		$respuesta = ControladorCanales::ctrBorrarCanal($item, $valor);
