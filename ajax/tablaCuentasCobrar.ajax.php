...
class TablaCuentasCobrar{
	...
	public function mostrarTabla(){
        ...
        $cuentas = ControladorCuentasCobrar::ctrMostrarCuentaCobrarInner($item1, $valor1, $item2, $valor2, $item3, $valor3, $tabla1, $tabla2, $order);
        //    
