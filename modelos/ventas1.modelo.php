...
static public function mdlMostrarCompradet($tabla,$item,$valor)
	...
	static public function mdlIngresarCtaspagar($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(COD_COMPRA,FECHA,CANT_CUOTA,MONTO_CUOTA,TOTAL_CUENTA,FECHA_VENCIMIENTO,TIPO_VENTA, ESTADO_CUENTA) VALUES (:cod_compra,:fecha,:cantidad_cuota,:monto_cuota,:preciototal,:fecha_vencimiento,:cmbTipoPago,:estado)");
