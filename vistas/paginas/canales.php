...
<main class="app-content">
  ...
  <div class="app-title">
    ...
    <h5><button class="btn btn-primary btnNuevo" type="button"  data-toggle="modal" data-target="#ModalCanales"><i class="fas fa-plus-circle"></i> Agregar Nuevo </button> Crear canales </h5>
