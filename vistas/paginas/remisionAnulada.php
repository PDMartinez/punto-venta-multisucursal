   ...
   <!-- EMPIEZA LA CABECERA DEL DOCUMENTO -->
    ...
    <div class="app-title">         
      ...
      <div class="ListarContenido">
        ...
        <h4 style="color:red">Administrar remisiones anuldas</h4>
                  <!-- FECHA ENTRE RANGOS -->
         ...
         <a href="remision">
              <button class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Ir a remisiones emitidas" type="button" title=""> Ir a remisiones emitidas
        </button> 
        </a>
