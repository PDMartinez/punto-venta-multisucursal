   ...
   <!-- EMPIEZA LA CABECERA DEL DOCUMENTO -->
    ...
    <div class="app-title">         
      ...
      <div class="ListarContenido">
        ...
        <h4>Administrar compras emitidas</h4>
            ...
            <div class="row">
                ...
                <div class="p-1">
                   ...
                   <button class="btn btn-primary btnNuevo" type="button" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Crear nueva compra"><span class="d-none d-lg-block d-xl-block "> <i class="fas fa-plus-circle"></i> Agregar Nuevo</span> <span class="d-lg-none d-xl-none"> <i class="fas fa-plus-circle"></i></span></button> 
                   ...
                   <a href="comprasAnulada">
                          <button class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Ir a compras anuladas" type="button" title=""><span class="d-none d-lg-block d-xl-block " ><i class="fa-solid fa-ban"></i> Compras anuladas</span><span class="d-lg-none d-xl-none"><i class="fa fa-ban"></i>
                          </button> 
      ...
      <div class=" notblock CargarCompra">
        ...
        <h3 class="text-gray-dark" id="titulo">Cargar compras</h3>
        <div class='btn-group'>
            
            
          <button class="btn btn-primary btnListar" type="button"><i class="fas fa-th-list"></i> Listar compras</button>
