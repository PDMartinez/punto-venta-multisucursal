...
<main class="app-content">
      ...
      <h5><button class="btn btn-primary btnNuevo" type="button"  data-toggle="modal" data-target="#ModalDescuento"><i class="fas fa-plus-circle"></i> Agregar Nuevo </button> Asignar descuentos a productos </h5>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="cmbCanal" id="cmbCanal" style="width: 100%;" required="">
          ...
          <div class="form-row" >
            ...
            <div class="form-group col-md-6">
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="txtDesde" id="txtDesde" placeholder="Ingresar cantidad desde" onkeyup="format(this)" onchange="format(this)" required>
            ...
            <div class="form-group col-md-6">
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="txtHasta" id="txtHasta" placeholder="Ingresar cantidad hasta" onkeyup="format(this)" onchange="format(this)" required>
...
<script src="vistas/js/descuentosProductos.js"></script>
