...
$(document).on("click", ".editarDescuento", function() {
  ...
  $.ajax({
    ...
    success: function(respuesta) {
      ...
      $("#txtDesde").val(respuesta["MONTO_DESDE"]);
      $("#txtDesde").number(true,0);

      $("#txtHasta").val(respuesta["MONTO_HASTA"]);
      ...
      $("#desde").val(respuesta["MONTO_DESDE"]);
      $("#hasta").val(respuesta["MONTO_HASTA"]);
              ...
              '<table class="table table-sm">'+
                ...
                '<thead>'+
                  ...
                  '<tr>'+
                    ...
                    '<th><center>#</center></th>'+
                    '<th><center>Monto Desde</center></th>'+
                    '<th><center>Monto Hasta</center></th>'+
                ...
                '<!-- MONTO DESDE -->'+
                  ...
                  '<div class="form-group '+value[3]+'">'+
                    ...
                    '<div class="input-group"">'+
                      ...
                      '<input type="text" class="form-control text-center nuevoDesde" idDesde="'+value[3]+'" name="nuevoDesde" value="'+ new Intl.NumberFormat("de-DE").format(value[3]) +' Gs" readonly>'+
                      // '<label class="control-label">"'+value[3]+'" <span style="color:red">*</span></label>'+
                ...
                '<!-- MONTO HASTA -->'+
                  ...
                  '<div class="form-group '+value[4]+'">'+
                    ...
                    '<div class="input-group">'+
                      ...
                      '<input type="text" class="form-control text-center nuevoHasta" idHasta="'+value[4]+'" name="nuevoHasta" value="'+ new Intl.NumberFormat("de-DE").format(value[4]) +' Gs" readonly>'+
...
//   $("#txtDesde").keyup(function(event){

//     // alert("KEY");

//     $("#txtHasta").val($("#txtDesde").val());
